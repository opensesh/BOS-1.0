...
export default function ArtDirectionGallery() {
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Title - matching Color subsection styling */}
      ...
      <div className="flex flex-wrap gap-2 items-center">
        {categories.map((category) => {
          ...
          return (
            <motion.button
              ...
              className={cn(
                "px-5 py-2.5 rounded-full font-text text-button transition-all duration-200",
                isActive
        ...
        <motion.button
          ...
          className={cn(
            "px-5 py-2.5 rounded-full font-text text-button transition-all duration-200 flex items-center gap-2 ml-auto",
            isDownloading
        ...
        >
          ...
          {isDownloading ? "Downloading..." : `Download ${selectedCategory}`}
        </motion.button>
      </div>
