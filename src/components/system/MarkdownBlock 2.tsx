...
const WRITING_STYLES: MarkdownFile[] = [
  { name: 'blog-post', path: '/brand/writing-styles/blog-post.md', displayName: 'Blog Post' },
    ...
    <div id="markdown" className="flex flex-col gap-12 py-12">
      ...
      <div className="flex flex-col gap-8">
        ...
        <p className="font-text text-b1 text-brand-vanilla/70 max-w-3xl">
          ...
          materials for AI to understand our guidelines and as direct examples of our writing style. Download or use markdown 
          files as custom GPTs with OpenAI, wiriting styles with Claude, or custom Gems Gemini
        </p>
      </div>
